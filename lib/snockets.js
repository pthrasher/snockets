...
(function() {
  ...
  module.exports = Snockets = (function() {
    ...
    Snockets.prototype.getConcatenation = function(filePath, flags, callback) {
      ...
      return this.updateDirectives(filePath, flags, function(err, graphChanged) {
        var absLink, cacheMiss, cacheValid, cached, catjs, catmaps, chain, concatenation, doMinify, doSrcMap, e, hasData, hasMinData, hasSrcMap, isCompiled, js, link, minopts, result, sources, srcmap, targetUrl, toMinify, _cacheValid, _hasJs, _hasMinData, _hasSrcMap, _i, _len, _maps, _mindata, _sources, _srcmap;
