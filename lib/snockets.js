(function() {
  ...
  module.exports = Snockets = (function() {
    function Snockets(options) {
      var errorStr, _base, _base1, _base2, _base3, _base4, _base5, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      ...
      if ((_ref1 = (_base1 = this.options).target) == null) {
        _base1.target = null;
      }
      if ((_ref2 = (_base2 = this.options).staticRoot) == null) {
        _base2.staticRoot = null;
      }
      if ((_ref3 = (_base3 = this.options).staticRootUrl) == null) {
        _base3.staticRootUrl = '/';
      }
      if ((_ref4 = (_base4 = this.options).src) == null) {
        _base4.src = '.';
      }
      if ((_ref5 = (_base5 = this.options).async) == null) {
        _base5.async = true;
      }
      this.cache = {};
      this.concatCache = {};
