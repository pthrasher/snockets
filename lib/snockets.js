(function() {
  var DIRECTIVE, DepGraph, EXPLICIT_PATH, HEADER, HoldingQueue, Snockets, compilers, fs, getUrlPath, jsExts, minify, parseDirectives, path, sourceMapCat, stripExt, timeEq, _, _ref, _ref1,
  ...
  Snockets = (function() {
    ...
    Snockets.prototype.updateDirectives = function(filePath, flags, excludes, callback) {
      ...
      return this.readFile(filePath, flags, function(err, fileChanged) {
        var command, directive, relPath, relPaths, words, _content, _i, _j, _k, _len, _len1, _len2, _ref2;
        ...
        _content = _this.cache[filePath].data.toString('utf8');
        _ref2 = parseDirectives(_content);
